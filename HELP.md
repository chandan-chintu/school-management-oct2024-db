...
* The original package name 'com.jpahibernate.example.school-management-db' is invalid and this project uses 'com.jpahibernate.example.school_management_db' instead.
